          ...
          <div class="card-body">
            ...
            <form id="formAuthentication" class="mb-3" action="auth.php" method="POST">
              ...
              <div class="mb-3">
                ...
                <!-- <input type="text" class="form-control" name="level" placeholder="Masukan username" autofocus/> -->
              </div>
              <button class="btn btn-primary d-grid w-100" name="login">Sign up</button>
            </form>
